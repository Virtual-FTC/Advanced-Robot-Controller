...
public class Header extends Message {
	...
	private final com.qualcomm.robotcore.hardware.basicwebsocket.primitives.Time stamp;
	 ...
	 */
	public Header() {
		this(0, new com.qualcomm.robotcore.hardware.basicwebsocket.primitives.Time(), "");
	}
	 ...
	 *            The frame ID.
	 */
	public Header(int seq, com.qualcomm.robotcore.hardware.basicwebsocket.primitives.Time stamp,
	 ...
	 */
	public com.qualcomm.robotcore.hardware.basicwebsocket.primitives.Time getStamp() {
		return this.stamp;
	}
	...
	public static Header fromJsonObject(JsonObject jsonObject) {
		...
		com.qualcomm.robotcore.hardware.basicwebsocket.primitives.Time stamp = jsonObject
				.containsKey(Header.FIELD_STAMP) ? com.qualcomm.robotcore.hardware.basicwebsocket.primitives.Time
